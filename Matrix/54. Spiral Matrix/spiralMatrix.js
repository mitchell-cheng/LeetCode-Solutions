...
const addTop = (top, bot, left, right, result, matrix) => {
  for (let col = left; col <= right; col++) {
    result.push(matrix[top][col]);
  }
}

const addRight = (top, bot, left, right, result, matrix) => {
  for (let row = top; row <= bot; row++) {
    result.push(matrix[row][right]);
  } 
}

const addBot = (top, bot, left, right, result, matrix) => {
  for (let col = right; col >= left; col--) {
    result.push(matrix[bot][col]);
  }
}

const addLeft = (top, bot, left, right, result, matrix) => {
